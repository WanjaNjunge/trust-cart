      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
          ...
          <div className="md:col-span-1">
            <h3 className="text-xl font-bold text-slate-900">TrustCart Kenya</h3>
        ...
        <div className="mt-12 flex flex-col items-center justify-between border-t border-slate-100 pt-8 md:flex-row">
          ...
          <div className="mt-4 flex items-center gap-2 md:mt-0">
            <span className="text-xs text-slate-600">Secure payments via</span>
            <span className="rounded border border-green-600/20 bg-green-50 px-2 py-1 text-xs font-bold text-green-600">
              M-PESA
            </span>
          </div>
        </div>
