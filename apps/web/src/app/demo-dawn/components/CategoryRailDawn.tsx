...
export function CategoryRailDawn() {
  return (
    <div className="relative z-20 w-full border-b border-slate-200/60 bg-white/60 backdrop-blur-md shadow-[0_2px_8px_rgba(0,0,0,0.02)]">
