...
import { CategoryRailDawn } from './components/CategoryRailDawn';

const IMAGEKIT_BASE = 'https://ik.imagekit.io/nr5uqiflj/trustcart';

// --- Dawn Theme Constants ---
const THEME_DAWN = {
  bg: 'bg-slate-50',
  surface: 'bg-white',
  surfaceHighlight: 'bg-slate-100',
  textPrimary: 'text-slate-900',
  textSecondary: 'text-slate-500',
  // Golden Hour Palette
  accentGold: 'from-amber-400 via-yellow-400 to-amber-500',
  accentGoldHover: 'from-amber-500 via-yellow-500 to-amber-600',
...
function HeroSection() {
  ...
  return (
    <section
      className={`relative flex min-h-screen flex-col justify-center overflow-hidden ${THEME_DAWN.bg} pt-20`}
    >
      {/* Background Atmosphere (Golden Hour) */}
      {/* 1. Sunlight Blob (Top Right) simulating morning sun */}
      <div className="absolute top-0 right-0 h-[800px] w-[800px] bg-gradient-to-bl from-orange-100/40 via-amber-50/20 to-transparent blur-3xl pointer-events-none" />

      {/* 2. Soft Ambient Mesh for warmth */}
      <div
        className={`absolute inset-0 bg-gradient-to-br ${THEME_DAWN.sunlight} opacity-60 pointer-events-none`}
      />

      {/* 3. Micro Grid (Barely Visible Structure) */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(0,0,0,0.01)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,0.01)_1px,transparent_1px)] bg-[size:40px_40px] opacity-20 pointer-events-none" />
      ...
      <div className="container relative z-10 mx-auto grow px-4">
        <div className="grid h-full items-center gap-16 pb-20 lg:grid-cols-2">
          ...
          >
            ...
            {/* Carousel Indicators (Soft Design) */}
          ...
          <div className="relative flex items-center justify-center">
            {/* Background Decoration (Light Gradient Blob) */}
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="relative aspect-square">
                  ...
                  {/* Floating Metric Card - Light Glass */}
...
function CategoriesSection() {
  return (
    <section className={`relative ${THEME_DAWN.bg} py-24`}>
...
// Reuse PopularCard logic but adapt for Light Theme
...
function DawnThemePage() {
  ...
  return (
    <main className={`min-h-screen ${THEME_DAWN.bg} text-slate-900`}>
      <DawnHeader />
      <HeroSection />
      <CategoriesSection />
      <PopularSection />
