...
*This document defines how data flows through the system. All implementations must respect ownership boundaries and privacy controls. Deviations require explicit approval.*
