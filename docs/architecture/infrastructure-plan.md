...
_This document defines the infrastructure plan. All environments must be provisioned according to these specifications. Deviations require explicit approval and documentation._
