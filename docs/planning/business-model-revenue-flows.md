...
*This document serves as the financial source of truth. All payment, pricing, refund, and revenue recognition logic must align with these rules. Deviations require explicit written approval.*
