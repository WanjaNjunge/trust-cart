...
*This document defines the screen inventory and serves as the foundation for UI/UX design and frontend development. All screens must implement the components and behaviors specified here.*
