...
_This document defines the environment strategy. All teams must follow these rules for data handling, secrets management, and code promotion. Violations require immediate escalation._
