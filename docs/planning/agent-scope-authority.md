...
_This document defines agent operating boundaries. The agent must operate within these constraints at all times. Violations require immediate escalation and review._
