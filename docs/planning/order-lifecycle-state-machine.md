...
_This document governs all order processing. Any deviation from defined transitions must be logged as an exception and reviewed. System implementations must enforce these rules without exception._
